...
puts "Muck uses jammit to package css and javascript files. Be sure to run 'jammit' before you deploy include it in your deploy process. Also, be careful modifying the 'admin' sections of your assets.yml file."
puts "Next steps:"
puts "1. Install other muck functionality:"
puts "   Run rake rails:template LOCATION=https://github.com/jbasdf/rails-templates/raw/master/muck_too.rb"
puts "2. Install tests:"
puts "   rake rails:template LOCATION=https://github.com/jbasdf/rails-templates/raw/master/muck_test.rb"
